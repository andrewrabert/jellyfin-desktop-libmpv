# mpv-fork.cmake - Build mpv from andrewrabert/mpv fork
# This file replaces packages/mpv.cmake in mpv-winbuild-cmake

# Allow configuring the fork repo and ref via CMake variables
if(NOT DEFINED MPV_FORK_REPO)
    set(MPV_FORK_REPO "andrewrabert/mpv")
endif()

if(NOT DEFINED MPV_FORK_REF)
    set(MPV_FORK_REF "libmpv-vulkan-gpu-next")
endif()
...
ExternalProject_Add(mpv
    DEPENDS
        ...
        libsdl2
        subrandr
    GIT_REPOSITORY https://github.com/${MPV_FORK_REPO}.git
    GIT_TAG ${MPV_FORK_REF}
...
ExternalProject_Add_Step(mpv copy-binary
    ...
    COMMAND ${CMAKE_COMMAND} -E copy <SOURCE_DIR>/include/mpv/render_vk.h    ${CMAKE_CURRENT_BINARY_DIR}/mpv-dev/include/mpv/render_vk.h
